...
public class MainActivity extends AppCompatActivity {
    View view1, view2,view7, view3, view4, view5, view6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // add guid view with list
        List<GuideModel> list = new ArrayList<>();
        list.add(new GuideModel(view1, "ini title view 1", "ini message view 1"));
        list.add(new GuideModel(view7, "ini title view 2", "ini message view 2", WelcomeActivity.class,true));
